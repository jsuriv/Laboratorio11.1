...
TextureManager::TextureManager()
{
	...
	framesAnimacionFantasmaClasico->addCuadroAnimacion("arriba", new SDL_Rect({ 0, 0, 25, 25 }));
	framesAnimacionFantasmaClasico->addCuadroAnimacion("arriba", new SDL_Rect({ 25, 0, 25, 25 }));
